...
def main():
    jobs = [
        ("111", "magnetization_z", "extrapolation-5-111_scaling.pdf"),
        ("000", "magnetization_z", "extrapolation-5-000_scaling.pdf"),
        ("+++", "magnetization_z", "extrapolation-5-+++_scaling.pdf"),
        ("mixed", "magnetization_z", "extrapolation-5-mixed_scaling.pdf"),
        ("111", "nearest_neighbor_zz", "extrapolation-5-111_zz_scaling.pdf"),
        ("000", "nearest_neighbor_zz", "extrapolation-5-000_zz_scaling.pdf"),
        ("+++", "nearest_neighbor_zz", "extrapolation-5-+++_zz_scaling.pdf"),
        ("mixed", "nearest_neighbor_zz", "extrapolation-5-mixed_zz_scaling.pdf"),
    ]
    all_summary = {}
    ...
    summary_path = OUT_DIR / "extrapolation_observable_scaling_summary.json"
